import {
  Ripple
} from "./chunk-42SI7ILW.js";
import {
  BaseInput
} from "./chunk-O43JYZJM.js";
import {
  AutoFocus,
  ConnectedOverlayScrollHandler,
  unblockBodyScroll
} from "./chunk-LPJVTE6U.js";
import {
  InputText
} from "./chunk-UPR4R4EH.js";
import {
  Scroller
} from "./chunk-RGD6RMJQ.js";
import {
  BlankIcon,
  CheckIcon,
  ChevronDownIcon,
...
var p2 = (t, n) => {
  ...
  if (T) for (var e of T(n)) V3.call(n, e) && D2(t, e, n[e]);
  return t;
};
...
function A(t, n) {
  ...
  }, [m, i] = o(v), [M2, f] = o(E), r = Math.max(...i.map((l2, c) => l2 + m[c])), u = Math.max(...f.map((l2, c) => l2 + M2[c])), a, s3 = 0, d = 0;
  return n === v ? r > 0 && (a = v, s3 = r, d = i.length) : n === E ? u > 0 && (a = E, s3 = u, d = f.length) : (s3 = Math.max(r, u), a = s3 > 0 ? r > u ? v : E : void 0, d = a ? a === v ? i.length : f.length : 0), { type: a, timeout: s3, count: d };
}
function $2(t, n) {
...
function tt(t, n) {
  ...
  let e = {}, o = false, m = {}, i = null, M2 = {}, f = (a) => {
    if (Object.assign(e, k3(a, U2)), !e.enter && !e.leave) throw new Error("Enter or leave must be true.");
    M2 = W2(e), o = H(e), m = L2(e), i = null;
    ...
    let { from: g, active: y3, to: P3 } = m[a] || {};
    return S(t, e.autoHeight, e.autoWidth), s3 == null || s3(h), W(t, g), W(t, y3), t.offsetHeight, P2(t, g), W(t, P3), d == null || d(h), new Promise((b) => {
      let C2 = $2(e.duration, a), x2 = () => {
        P2(t, [P3, y3]), i = null;
      }, R = () => {
        x2(), l2 == null || l2(h), b();
      };
...
//# sourceMappingURL=chunk-YJQXW66Z.js.map
